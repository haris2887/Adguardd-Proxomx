...
pct create $number local:vztmpl/alpine-3.14-default_20210623_amd64.tar.xz --ostype alpine --hostname $name --net0 name=eth0,ip=dhcp,bridge=vmbr0 --memory 512 --cores $cpu --unprivileged 1 --nameserver 9.9.9.9 --cmode shell
pct start $number
